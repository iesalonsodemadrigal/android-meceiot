...
import edu.iesam.meceiot.features.pantallasensor.data.remote.GraphSensorRetrofitRemoteDataSource
...
class GraphGraphSensorDataRepository(
    private val remoteDataSource: GraphSensorRetrofitRemoteDataSource,
