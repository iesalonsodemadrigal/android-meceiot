...
@Database(
    entities = [LoraWanEntity::class, ExternalResourcesEntity::class, DeveloperEntity::class, QuestionEntity::class, PanelEntity::class, SensorEntity::class, GraphSensorEntity::class],
    version = 8,
    exportSchema = false
)
@TypeConverters(
    DateConverter::class,
    TypeSensorConverter::class,
